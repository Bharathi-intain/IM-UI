...
declare const _default: {
    ...
    TextWidget: ({ id, placeholder, required, readonly, disabled, type, label, value, onChange, onBlur, onFocus, autofocus, options, schema, rawErrors, uiSchema, }: import("@rjsf/core").WidgetProps) => JSX.Element;
