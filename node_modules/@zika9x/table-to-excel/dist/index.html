<html>
  ...
  <body>
    <div id="wrapper">
      <table id="simpleTable1" data-cols-width="70,15,10" data-cols-height="70,15,10">
        <tbody>
          <tr>
      ...
      <button id="button-excel" onclick="exportExcel()">Create Excel</button>

      <table id="sampletable2" border="1">
        <tr>
          <th colspan="6" data-b-a-s="thin" data-a-h="center" data-f-bold="true">
            Things
          </th>
        </tr>
        <tr>
